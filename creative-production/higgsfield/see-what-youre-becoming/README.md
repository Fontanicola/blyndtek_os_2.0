...
1. [`concept.md`](concept.md) — idea, tesis y trabajo de marca.
2. [`script.md`](script.md) — guion inglés de 60 segundos.
3. [`beat-sheet.md`](beat-sheet.md) — película segundo a segundo.
4. [`visual-treatment.md`](visual-treatment.md) — imagen, cámara, sonido y escala.
...
- la tesis “visibility should not be reserved for giants”;
- la plataforma “See what you’re becoming”;
- el tratamiento de tres operaciones latinoamericanas a escala épica;
