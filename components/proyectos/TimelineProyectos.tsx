          ...
          <div className="grid grid-cols-[260px_repeat(48,minmax(52px,1fr))]">
            ...
            {projectRows.map((project, index) => {
              ...
              return <div key={project.id} className="contents">
                <div className="sticky left-0 z-10 grid min-h-[150px] grid-cols-[minmax(0,1fr)_42px] grid-rows-[32px_32px_32px_1fr] border-b-2 border-line bg-white">
                  ...
                  <div className="row-span-4 grid grid-rows-[32px_32px_32px_1fr] border-l border-line text-graphite"><span className="flex items-center justify-center border-b border-line-soft text-xs" title="Duración">■</span><span className="flex items-center justify-center border-b border-line-soft text-sm" title="Hitos de pago">$</span><span className="flex items-center justify-center border-b border-line-soft text-sm" title="Reuniones"><VideoIcon size={15} /></span></div>
                </div>
                <div className="relative border-l-2 border-b-2 border-line" style={{ gridColumn: `2 / span ${TOTAL_WEEKS}` }}>
                  ...
                  <div className="pointer-events-none absolute inset-x-0 top-10 border-t border-line-soft" />
                  <div className="pointer-events-none absolute inset-x-0 top-[84px] border-t border-line-soft" />
                  <div className="pointer-events-none absolute inset-x-0 top-32 border-t border-line-soft" />
