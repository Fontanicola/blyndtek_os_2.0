          ...
          <div className="grid grid-cols-[260px_repeat(48,minmax(72px,1fr))]">
            ...
            {projectRows.map((project, index) => {
              ...
              return <div key={project.id} className="contents">
                <div className="sticky left-0 z-20 grid h-[224px] grid-cols-[minmax(0,1fr)_48px] grid-rows-[56px_56px_56px_56px] overflow-hidden border-b-2 border-r-2 border-line bg-white">
