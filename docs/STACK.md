...
| Meta Marketing API | Graph API v26 server-side, lectura y pausa controlada | Campañas, conjuntos, anuncios, creatividades, insights, reglas, aprobación y simulación | El token vive en Vercel. Sólo una pausa manual aprobada puede ejecutarse detrás de dos kill switches; reactivación, creación y presupuesto están bloqueados. |
